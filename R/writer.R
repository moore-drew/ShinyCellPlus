...
wrSVgeneOnt <- function(prefix, gene.ont) {
  if(gene.ont == TRUE) {
    glue::glue(
              ...
              '      }} \n',
              '      else {{ \n',
              '        if(class(p)[1] == "list") {{ # if multiple clusters were selected and only one of them wasn\'t empty (a list of ggplots of length 1 is returned)...  \n',
              ...
              '                       choices = as.character(sort(clusters)), selected = clusters[1]) \n',
              '  }}) \n',
              '  \n',
              ...
              '                             choices = as.character(sort(clusters)), selected = clusters, inline = TRUE) \n',
              '  }}) \n',
              '  \n',
              '  observeEvent(input$gont_cluster_vals_desel_all, {{ \n', 
              '    clusters = unique({prefix}gene_ont$Cluster) \n',
              '    updateCheckboxGroupInput(session, inputId = "gont_cluster_vals2", label = "Select clusters:", \n',
              '                             choices = as.character(sort(clusters)), selected = NULL, inline = TRUE) \n',
              '  }}) \n',
              '  \n', 
