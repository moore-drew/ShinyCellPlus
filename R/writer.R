...
wrSVvolc <- function(prefix, volc.plot) {
  ...
  glue::glue(
            ...
            '    }} \n',
            '    else {{ \n',
            '      scVolc({prefix}conf, {prefix}de_genes_ggvolc, input$volc_de_select, genes_selection=NULL, input$volc_subset, input$volc_subset2, \n',
            ...
            '      plot = scVolc({prefix}conf, {prefix}de_genes_ggvolc, input$volc_de_select, genes_selection=NULL, input$volc_subset, input$volc_subset2, \n',
            '             input$volc_fold_change, input$volc_p_value, input$volc_subset_toggle, input$volc_top10_toggle, input$volc_xlim_down, input$volc_xlim_up, input$volc_ylim) \n',
            '      ) \n',
            '    }} \n',
            '  ) \n',
...
wrUIvolc <- function(prefix, volc.plot) {
  ...
  if(volc.plot == TRUE) {
    graphs <- graphs + glue::glue(
      ...
      '        sliderInput("volc_xlim_up", "Change upperbound range of foldchange", 0, 10, 5, round=-1, step=0.1), \n',
      '        sliderInput("volc_xlim_down", "Change lowerbound range of foldchange", -10, 0, -5, round=-1, step=0.1), \n',
