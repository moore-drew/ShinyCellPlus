...
wrUIgeneOnt <- function(prefix, gene.ont) {
  ...
  if(gene.ont == TRUE) {
    graphs <- graphs + glue::glue(
       ...
       '        br(), \n',
       '        fillRow( \n',
       '          numericInput("gont_download_height", "PDF / PNG height:", value=35, min=4, max=100, step=0.5, width="138px"), \n',
       '          numericInput("gont_download_width", "PDF / PNG width:", value=35, min=4, max=100, step=0.5, width="140px"), \n',
       '          width="75%" \n',
       '        ), \n',
       '        br(),br(),br(),br(), \n', 
