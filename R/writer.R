...
wrUImain <- function(prefix, subst = "", ptsiz = "1.25") {
  glue::glue('  ### Tab1.a1: cellInfo vs geneExpr on dimRed \n',
             ...
             '### Tab1.a1b: SPLIT CELL INFO \n',
              ...
              'fluidRow( \n',
              'column( \n',
              '12, selectInput("{prefix}a1bdrX", "X-axis:", choices = {prefix}conf[dimred == TRUE]$UI, \n',
              'selected = {prefix}def$dimred[1]), \n',
              ...
              '), # End of column (6 space) \n',
              'column( \n',
              '3, actionButton("{prefix}a1btogL", "Toggle to subset cells"), \n',
              'conditionalPanel( \n',
              ...
              '), # End of column (6 space) \n',
              'column( \n',
              '6, actionButton("{prefix}a1btog0", "Toggle graphics controls"), \n',
              'conditionalPanel( \n',
              'condition = "input.{prefix}a1btog0 % 2 == 1", \n',
              'fluidRow( \n',
              'column( \n',
              '6, sliderInput("{prefix}a1bsiz", "Point size:", \n',
              ...
              '), \n',
              'column( \n',
              '6, radioButtons("{prefix}a1basp", "Aspect ratio:", \n',
              'choices = c("Square", "Fixed", "Free"), \n',
              'selected = "Square", inline = TRUE), \n',
              ...
              'fluidRow( \n',
              'column( \n',
              '12, selectInput("{prefix}basplit1", "Split dataset:", \n',
              ...
              ') \n',
              '), \n',
              'fluidRow(column(12, uiOutput("{prefix}a1boup1.ui"))), \n',
              ...
              '#   ) \n',
              '# ) , \n',
              'fluidRow(column(12, uiOutput("{prefix}a1boup2.ui"))), \n',
              ...
              'fluidRow( \n',
              'column( \n',
              '12, selectInput("{prefix}a1cdrX", "X-axis:", choices = {prefix}conf[dimred == TRUE]$UI, \n',
              'selected = {prefix}def$dimred[1]), \n',
              ...
              '), # End of column (6 space) \n',
              'column( \n',
              '3, actionButton("{prefix}a1ctogL", "Toggle to subset cells"), \n',
              'conditionalPanel( \n',
              ...
              '), # End of column (6 space) \n',
              'column( \n',
              '6, actionButton("{prefix}a1ctog0", "Toggle graphics controls"), \n',
              'conditionalPanel( \n',
              'condition = "input.{prefix}a1ctog0 % 2 == 1", \n',
              'fluidRow( \n',
              'column( \n',
              '6, sliderInput("{prefix}a1csiz", "Point size:", \n',
              'min = 0, max = 4, value = 1.25, step = 0.25), \n',
              ...
              '), \n',
              'column( \n',
              '6, radioButtons("{prefix}a1casp", "Aspect ratio:", \n',
              'choices = c("Square", "Fixed", "Free"), \n',
              'selected = "Square", inline = TRUE), \n',
              ...
              'fluidRow( \n',
              'column( \n',
              '12, selectInput("{prefix}casplit1", "Split dataset:", \n',
              'choices = {prefix}conf[{prefix}conf$split==TRUE]$UI) \n',
              ') \n',
              ') \n',
              '), \n',
              ...
              '), \n',
              'column( \n',
              '6, actionButton("{prefix}a1ctog1", "Toggle plot controls"), \n',
              'conditionalPanel( \n',
              ...
              ' \n',
              '), \n',
              'fluidRow(column(12, uiOutput("{prefix}a1coup1.ui"))), \n',
              ...
              '# ), \n',
              'column( \n',
              '6, actionButton("{prefix}a1ctog2", "Toggle plot controls"), \n',
              'conditionalPanel( \n',
              ...
              ') \n',
              '), \n',
              'fluidRow(column(12, uiOutput("{prefix}a1coup2.ui"))), \n',
