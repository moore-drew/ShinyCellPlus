...
wrSVmain <- function(prefix, subst = "") {
  glue::glue('optCrt="{{ option_create: function(data,escape) {{return(\'<div class=\\"create\\"><strong>\' + \'</strong></div>\');}} }}" \n', 
             ...
             '   input${prefix}a1bsub1, input${prefix}a1bsub2, \n',
             '   input${prefix}a1bsiz, input${prefix}a1bcol1, input${prefix}a1bord1, \n',
             '   input${prefix}a1bfsz, input${prefix}a1basp, input${prefix}a1btxt, input${prefix}a1blab1, insplit=input${prefix}a1bsplit1, split_idx=1, select=input${prefix}a1bsplit_select1_out2) ) \n',
             ' }}) \n',
             ...
             '     input${prefix}a1bsub1, input${prefix}a1bsub2, \n',
             '     input${prefix}a1bsiz, input${prefix}a1bcol1, input${prefix}a1bord1, \n',
             '     input${prefix}a1bfsz, input${prefix}a1basp, input${prefix}a1btxt, input${prefix}a1blab1, insplit=input${prefix}a1bsplit1, split_idx=2, select=input${prefix}a1bsplit_select2_out2)) \n',
             '}}) \n',
...
wrSVvolc <- function(prefix, volc.plot) {
  ...
  glue::glue(
            '  #### volcano plot \n',
            '  scVolc <- function(de_genes, de_genes_selections, de_genes_subset, fold_change, subset_toggle, \n',
            '                     top10_toggle) {{ \n',
            '    # if  don\'t have {prefix}de_genes.rds {{ \n',
            '      # return error graph \n',
            '    #}} \n',
            '    \n',  
            '    if(subset_toggle == 0) {{ # shotty hotfix for blank generated graph when subset menu hasn\'t been opened yet... \n',
            ...
            '      top_pos <- de_genes[ order(de_genes$log2FoldChange, decreasing=TRUE)[1:10], ] \n',
            '      top_neg <- de_genes[ order(de_genes$log2FoldChange)[1:10], ] \n',
            '      de_genes_selections <- rbind(top_pos, top_neg) \n',
            '    }} \n',
            '    \n',  
            '    ggOut <- ggvolc(de_genes, de_genes_selections, fc=fold_change, size_var="set_size") + labs(title=NA) \n',
            '    \n',  
            '    return(ggOut) \n',
            '  }} \n',
            '  \n',
            '  output$volc_subset.ui <- renderUI({{ \n', 
            '    subset = strsplit({prefix}conf[UI == input$volc_subset]$fID, "\\\\|")[[1]] \n',
            ...
            '    scVolc({prefix}de_genes_ggvolc, de_genes_selection=NULL, input$volc_subset2, \n',
            '           input$volc_fold_change, input$volc_subset_toggle, input$volc_top10_toggle) \n',
            '  }}) \n',
            .trim=FALSE
  )
    #)
